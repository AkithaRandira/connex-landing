  ...
  return (
    <div className="w-full pt-10 flex flex-col justify-start items-start">
      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        <div className="h-auto p-6 sm:p-8 md:p-12 lg:p-16 flex flex-col justify-start items-start gap-8">
          {/* Brand Section */}
          <div className="self-stretch flex justify-start items-center gap-3">
            <div className="text-center text-[#49423D] text-xl font-semibold leading-4 font-sans">Zentria Labs</div>
          </div>
        ...
        {/* Navigation Links */}
        <div className="flex-1 p-6 sm:p-8 md:p-12 lg:p-16 flex flex-col sm:flex-row flex-wrap justify-start sm:justify-between items-start gap-6 md:gap-8 max-w-4xl">
          {/* Products Column */}
